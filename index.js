...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderer(meta, component) {
	  ...
	  component.$sub = (0, _obj.objMap)(component.$sub, function (c, key) {
	    return c.$retained ? c : (0, _DOMRendererUtil.doneFn)(c);
	  });
	...
	function applyDOMAttributes(e, _attrs) {
	  ...
	  if (_attrs) {
	    ...
	    if (e.nodeName === '#text') {
	      ...
	      (0, _obj.objForEach)(lastAttrs, function (value, key) {
	        if (!(key in _attrs)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UiComponent = function (_Component) {
	  ...
	  _createClass(UiComponent, [{
	    ...
	    key: 'invalidate',
	    value: function invalidate(changed) {
	    ...
	    value: function update(delta) {
	      ...
	      var changed = _get(UiComponent.prototype.__proto__ || Object.getPrototypeOf(UiComponent.prototype), 'update', this).call(this, delta);
	    ...
	    value: function callChangedHooks(changed) {
	      ...
	      changed.forEach(function (_ref2) {
	        var key = _ref2.key,
	            value = _ref2.value,
	            oldValue = _ref2.oldValue;


	        var hook = _this2.get(key + 'Changed');
	        if (hook) {

	          try {

	            hook.call(_this2, { value: value, oldValue: oldValue, target: _this2, id: _this2.id });
	          } catch (ex) {

	            _this2.onError(_extends({}, ex, { message: 'Error in ' + key + ' hook: ' + ex.message }));
	          }
	        }
	      });
	    }
